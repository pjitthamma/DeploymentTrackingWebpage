...
while (strtotime($weekMonday) <= strtotime("today")) {
  ...
  $query = "SELECT count(*) as times from DeploymentRecord_bf where DeploymentDate >= '".$weekMonday."' and DeploymentDate <= '".$weekFriday."' and ReleaseStatus = 1;";
...
<body>
  ...
  <div class="container" id="center">
    ...
    <div class="row">
      ...
      <span>
        <a class="btn btn-success" href="dailyReport_bf_with_KPI.php">Base on Deployment KPI</a>
