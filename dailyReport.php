...
while (strtotime($weekMonday) <= strtotime("today")) {
  ...
  $query = "select count(*) as times from DeploymentRecord where DeploymentDate >= '".$weekMonday."' and DeploymentDate <= '".$weekFriday."' and ReleaseStatus = 1;";
...
<body>
  ...
  <div class="container" id="center">
    ...
    <div class="row">
      ...
      <span>
        <a class="btn btn-success" href="dailyReport_with_KPI.php">Base on Deployment KPI</a>
        <a class="btn btn-success" href="" disabled>Base on Total packages</a>
      </span>
      </div>
